...
Une fois les tables créées en base de données grâce au script SQL ci-dessus, nous pouvons consulter le Diagramme généré par notre interface de gestion de base de données ( ***DBeaver*** ):
